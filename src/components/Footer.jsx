...
const Footer = () => {
  ...
  const socialLinks = [
    ...
    {
      name: "Instagram",
      url: "https://instagram.com/i_sushil45ro",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          className="h-5 w-5"
  ...
  return (
    <footer className="bg-gradient-to-br from-cyan-100 via-blue-300 to-indigo-400 dark:bg-gray-900 py-12">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          {/* Quick Links */}
          <div className="col-span-1">
            <h3 className="text-lg font-semibold mb-4 text-dark dark:text-light">
              Quick Links
            </h3>
